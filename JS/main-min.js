!(function(e, t) {
  ...
  function C(e, t, n, i, o) {
        ...
        if ("object" === r(a)) Te.merge(d, a.nodeType ? [a] : a);
          ...
          for (
            s = s || p.appendChild(t.createElement("div")),
              u = (Ke.exec(a) || ["", ""])[1].toLowerCase(),
              l = et[u] || et._default,
              s.innerHTML = l[1] + Te.htmlPrefilter(a) + l[2],
              f = l[0];
            f--;
    ...
    for (p.textContent = "", h = 0; (a = d[h++]); )
      if (i && Te.inArray(a, i) > -1) o && o.push(a);
        ...
        ((c = Te.contains(a.ownerDocument, a)),
  ...
  function q(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        Be.hasData(e) &&
        ((o = Be.access(e)), (a = Be.set(t, o)), (l = o.events))
      )
        for (i in (delete a.handle, (a.events = {}), l))
          for (n = 0, r = l[i].length; n < r; n++) Te.event.add(t, i, l[i][n]);
      Fe.hasData(e) &&
        ((s = Fe.access(e)), (u = Te.extend({}, s)), Fe.set(t, u));
    }
  }
  function L(e, t) {
  ...
  function H(e, t, r, i) {
    ...
    var o,
      ...
      h = t[0],
      g = me(h);
    if (g || (p > 1 && "string" == typeof h && !ye.checkClone && ft.test(h)))
    ...
    if (
      p &&
      ((a = (o = C(t, e[0].ownerDocument, !1, e, i)).firstChild),
      1 === o.childNodes.length && (o = a),
      a || i)
    ) {
      for (u = (s = Te.map(w(o, "script"), A)).length; f < p; f++)
        (l = o),
          f !== d &&
            ((l = Te.clone(l, !0, !0)), u && Te.merge(s, w(l, "script"))),
          r.call(e[f], l, f);
      if (u)
        for (c = s[s.length - 1].ownerDocument, Te.map(s, j), f = 0; f < u; f++)
          (l = s[f]),
            Ze.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : n(l.textContent.replace(pt, ""), c, l));
    }
    return e;
  }
  function O(e, t, n) {
    for (var r, i = t ? Te.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || Te.cleanData(w(r)),
        r.parentNode &&
          (n && Te.contains(r.ownerDocument, r) && T(w(r, "script")),
  ...
  function W(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (u += Te.css(e, n + Ve[a], !0, i)),
        r
          ? ("content" === n && (u -= Te.css(e, "padding" + Ve[a], !0, i)),
            "margin" !== n &&
              (u -= Te.css(e, "border" + Ve[a] + "Width", !0, i)))
          : ((u += Te.css(e, "padding" + Ve[a], !0, i)),
            "padding" !== n
              ? (u += Te.css(e, "border" + Ve[a] + "Width", !0, i))
              : (s += Te.css(e, "border" + Ve[a] + "Width", !0, i)));
    return (
      !r &&
        o >= 0 &&
        (u += Math.max(
  ...
  function B(e, t, n) {
    ...
    return (
      (a = a && (ye.boxSizingReliable() || i === e.style[t])),
      ("auto" === i ||
        (!parseFloat(i) && "inline" === Te.css(e, "display", !1, r))) &&
        ((i = e["offset" + t[0].toUpperCase() + t.slice(1)]), (a = !0)),
      (i = parseFloat(i) || 0) +
        W(e, t, n || (o ? "border" : "content"), a, r, i) +
        "px"
    );
  }
  ...
  function V(e, t, n) {
    ...
    if ((u = !Te.isEmptyObject(t)) || !Te.isEmptyObject(d))
      for (r in (f &&
        ...
        null == (l = v && v.display) && (l = Be.get(e, "display")),
      ...
      d))
        u ||
          ...
          g && b([e], !0),
          p.done(function() {
            for (r in (g || b([e]), Be.remove(e, "fxshow"), d))
              Te.style(e, r, d[r]);
          })),
          (u = U(g ? v[r] : 0, r, p)),
  ...
  function Y(e, t, n) {
    ...
    for (G(c, l.opts.specialEasing); o < a; o++)
      if ((r = Y.prefilters[o].call(l, e, c, l.opts)))
        return (
          me(r.stop) &&
            (Te._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)),
          r
        );
    return (
      Te.map(c, U, l),
  ...
  (Te.fn = Te.prototype = {
    ...
    "function" == typeof Symbol &&
      (Te.fn[Symbol.iterator] = oe[Symbol.iterator]),
    Te.each(
  ...
  var Ee = (function(e) {
    function t(e, t, n, r) {
      ...
      if (
        !r &&
        ((t ? t.ownerDocument || t : B) !== H && L(t), (t = t || H), P)
      ) {
        if (11 !== h && (u = ye.exec(e)))
          if ((i = u[1])) {
            if (9 === h) {
            ...
            } else if (p && (a = p.getElementById(i)) && $(t, a) && a.id === i)
              return n.push(a), n;
          } else {
      ...
      var i = n.length > 0,
        ...
        a = function(r, a, s, u, l) {
          ...
          for (
            ...
            if (o && c) {
              for (
                f = 0, a || c.ownerDocument === H || (L(c), (s = !P));
                (p = e[f++]);
    ...
    (L = t.setDocument = function(e) {
      ...
      return r !== H && 9 === r.nodeType && r.documentElement
        ? ((O = (H = r).documentElement),
          ...
          (R = []),
          (M = []),
          (T.qsa = ve.test(H.querySelectorAll)) &&
            (i(function(e) {
            ...
            ? function(e, t) {
                ...
                return (
                  ...
                  (!T.sortDetached && t.compareDocumentPosition(e) === n)
                    ? e === H || (e.ownerDocument === B && $(B, e))
                      ? -1
                      : t === H || (t.ownerDocument === B && $(B, t))
                      ? 1
                      : j
                      ? ee(j, e) - ee(j, t)
                      : 0
          ...
          for (
            ...
            if (
              ...
              (r = u(
                ...
                (me.test(o[0].type) && f(t.parentNode)) || t
              ))
            ) {
  ...
  (Te.find = Ee),
    (Te.expr = Ee.selectors),
    (Te.expr[":"] = Te.expr.pseudos),
    (Te.uniqueSort = Te.unique = Ee.uniqueSort),
    (Te.text = Ee.getText),
    (Te.isXMLDoc = Ee.isXML),
    (Te.contains = Ee.contains),
    (Te.escapeSelector = Ee.escape);
  ...
  (Te.filter = function(e, t, n) {
    ...
    Te.fn.extend({
      ...
      is: function(e) {
        return !!a(
          this,
          "string" == typeof e && De.test(e) ? Te(e) : e || [],
          !1
        ).length;
      }
    });
    ...
    if (((n = n || Ae), "string" == typeof e)) {
      ...
      if (r[1]) {
        if (
          ...
          Te.merge(
            this,
            Te.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : ae, !0)
          ),
          Ne.test(r[1]) && Te.isPlainObject(t))
        )
          for (r in t) me(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
        return this;
      }
      return (
        (i = ae.getElementById(r[2])) && ((this[0] = i), (this.length = 1)),
        this
      );
    }
    return e.nodeType
      ...
      function(e, t) {
        Te.fn[e] = function(n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (He[e] || Te.uniqueSort(i), Le.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
    ...
    Te.extend({
      ...
      ready: function(e) {
        (!0 === e ? --Te.readyWait : Te.isReady) ||
          ((Te.isReady = !0),
          (!0 !== e && --Te.readyWait > 0) || Me.resolveWith(ae, [Te]));
      }
    }),
  ...
  var tt = /<|&#?\w+;/,
    ...
    rt,
    it;
  (rt = ae.createDocumentFragment().appendChild(ae.createElement("div"))),
    (it = ae.createElement("input")).setAttribute("type", "radio"),
    it.setAttribute("checked", "checked"),
    it.setAttribute("name", "t"),
    rt.appendChild(it),
    (ye.checkClone = rt.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (rt.innerHTML = "<textarea>x</textarea>"),
    (ye.noCloneChecked = !!rt.cloneNode(!0).lastChild.defaultValue);
  ...
  (Te.event = {
      ...
      if (v)
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            i && Te.find.matchesSelector(ot, i),
    ...
    dispatch: function(e) {
      ...
      if (
        ...
        for (
          s = Te.event.handlers.call(this, t, l), n = 0;
          ...
          for (
            ...
            (t.rnamespace && !t.rnamespace.test(a.namespace)) ||
              ...
              void 0 !==
                (i = (
                  (Te.event.special[a.origType] || {}).handle || a.handler
                ).apply(o.elem, u)) &&
                !1 === (t.result = i) &&
  ...
  !(function() {
    ...
    l.style &&
      ...
      (ye.clearCloneStyle = "content-box" === l.style.backgroundClip),
      Te.extend(ye, {
      ...
      run: function(e) {
        ...
        return (
          this.options.duration
            ? (this.pos = t = Te.easing[this.easing](
                e,
  ...
  (Te.Animation = Te.extend(Y, {
    ...
    (function() {
      var e = ae.createElement("input"),
        t,
        n = ae.createElement("select").appendChild(ae.createElement("option"));
      (e.type = "checkbox"),
        (ye.checkOn = "" !== e.value),
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === o && Te.isXMLDoc(e)) ||
                (i =
                  ...
                  (Te.expr.match.bool.test(t) ? St : void 0)),
              void 0 !== n
                ? null === n
    ...
    Te.extend({
      prop: function(e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return (
            (1 === o && Te.isXMLDoc(e)) ||
              ((t = Te.propFix[t] || t), (i = Te.propHooks[t])),
            void 0 !== n
              ? i && "set" in i && void 0 !== (r = i.set(e, n, t))
                ? r
                : (e[t] = n)
      ...
      toggleClass: function(e, t) {
        ...
        return "boolean" == typeof t && r
          ...
          : this.each(function() {
              var t, i, o, a;
              if (r)
                for (i = 0, o = Te(this), a = K(e); (t = a[i++]); )
                  o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = J(this)) && Be.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  Te.fn.extend({
    val: function(e) {
      ...
      return arguments.length
        ...
        : i
        ? (t = Te.valHooks[i.type] || Te.valHooks[i.nodeName.toLowerCase()]) &&
          "get" in t &&
  ...
  Te.extend(Te.event, {
    trigger: function(t, n, r, i) {
      ...
      if (
        ...
        3 !== r.nodeType &&
          8 !== r.nodeType &&
          !qt.test(h + Te.event.triggered) &&
          (h.indexOf(".") > -1 &&
            ((g = h.split(".")), (h = g.shift()), g.sort()),
          (l = h.indexOf(":") < 0 && "on" + h),
          ((t = t[Te.expando]
            ? t
            : new Te.Event(h, "object" == typeof t && t)).isTrigger = i
            ? 2
            : 3),
          (t.namespace = g.join(".")),
        ...
        if (!i && !f.noBubble && !xe(r)) {
          for (
            u = f.delegateType || h, qt.test(u + h) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            d.push(a), (s = a);
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              t.isPropagationStopped() && p.addEventListener(h, Lt),
              r[h](),
              t.isPropagationStopped() && p.removeEventListener(h, Lt),
  ...
  (Qt.href = Ht.href),
    Te.extend({
      ...
      ajax: function(t, n) {
        ...
        h.ifModified &&
          (Te.lastModified[o] &&
            C.setRequestHeader("If-Modified-Since", Te.lastModified[o]),
  ...
  Te.ajaxSetup({
    ...
    Te.ajaxPrefilter("json jsonp", function(t, n, r) {
      ...
      if (s || "jsonp" === t.dataTypes[0])
        return (
          (i = t.jsonpCallback = me(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          s
          ...
          r.always(function() {
            void 0 === o ? Te(e).removeProp(i) : (e[i] = o),
    ...
    (ye.createHTMLDocument =
      (((tn = ae.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    Te.each(["top", "left"], function(e, t) {
      Te.cssHooks[t] = M(ye.pixelPosition, function(e, n) {
        if (n)
          return (n = P(e, t)), dt.test(n) ? Te(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (Te.noConflict = function(t) {
      return (
        e.$ === Te && (e.$ = rn), t && e.jQuery === Te && (e.jQuery = nn), Te
      );
    }),
    t || (e.jQuery = e.$ = Te),
    Te
